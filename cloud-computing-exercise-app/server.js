...
app.put('/api/books/:id', (req, res) => {
  ...
  const update = bookNewData;

  let updatedBookInfo = {}
  BooksModel.findOneAndUpdate(filter, update).then((obj) => {
    updatedBookInfo = obj
  })
...
app.delete('/api/books/:id', (req, res) => {
   ...
   */
  var deletedBook = {};
  BooksModel.deleteOne({_id: bookId}).then((obj) => {
    deletedBook = obj
  })      
  // deletedBook = await BooksModel.deleteOne({_id: bookId})
